...
$(function(){
    ...
    $("#jsppage").load(basePath+"/views/demo/jsp/demo_query_navigation.jsp");
    $.ajax({
        url: basePath+"/views/demo/jsp/demo_query_navigation.jsp",
        type: "GET",
    ...
    $.ajax({
        url: basePath+"/views/demo/css/demo_query_navigation.css",
        type: "GET",
        success: function(data){
            $("#code_css").val(data);
    ...
    $.ajax({
        url: basePath+"/views/demo/js/js_self/demo_query_navigation.js",
        type: "GET",
        success: function(data){
