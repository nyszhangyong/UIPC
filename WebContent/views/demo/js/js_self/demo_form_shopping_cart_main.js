...
$(function(){
    ...
    $("#jsppage").load(basePath+"/views/demo/jsp/demo_form_shopping_cart.jsp");
    $.ajax({
        url: basePath+"/views/demo/jsp/demo_form_shopping_cart.jsp",
        type: "GET",
    ...
    $.ajax({
        url: basePath+"/views/demo/css/demo_form_shopping_cart.css",
        type: "GET",
        success: function(data){
            $("#code_css").val(data);
    ...
    $.ajax({
        url: basePath+"/views/demo/js/js_self/demo_form_shopping_cart.js",
        type: "GET",
        success: function(data){
