...
$(function(){
    ...
    $("#jsppage").load(basePath+"/views/demo/jsp/demo_query_page_custom_list.jsp");
    $.ajax({
        url: basePath+"/views/demo/jsp/demo_query_page_custom_list.jsp",
        type: "GET",
    ...
    $.ajax({
        url: basePath+"/views/demo/css/demo_query_page_custom_list.css",
        type: "GET",
        success: function(data){
            $("#code_css").val(data);
    ...
    $.ajax({
        url: basePath+"/views/demo/js/js_self/demo_query_page_custom_list.js",
        type: "GET",
        success: function(data){
