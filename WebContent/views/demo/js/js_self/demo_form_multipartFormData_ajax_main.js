...
$(function(){
    ...
    $("#jsppage").load(basePath+"/views/demo/jsp/demo_form_multipartFormData_ajax.jsp");
    $.ajax({
        url: basePath+"/views/demo/jsp/demo_form_multipartFormData_ajax.jsp",
        type: "GET",
    ...
    $.ajax({
        url: basePath+"/views/demo/css/demo_form_multipartFormData_ajax.css",
        type: "GET",
        success: function(data){
            $("#code_css").val(data);
    ...
    $.ajax({
        url: basePath+"/views/demo/js/js_self/demo_form_multipartFormData_ajax.js",
        type: "GET",
        success: function(data){
