...
$(function(){
    ...
    $("#jsppage").load(basePath+"/views/demo/jsp/demo_query_simple.jsp");
    $.ajax({
        url: basePath+"/views/demo/jsp/demo_query_simple.jsp",
        type: "GET",
    ...
    $.ajax({
        url: basePath+"/views/demo/css/demo_query_simple.css",
        type: "GET",
        success: function(data){
            $("#code_css").val(data);
    ...
    $.ajax({
        url: basePath+"/views/demo/js/js_self/demo_query_simple.js",
        type: "GET",
        success: function(data){
