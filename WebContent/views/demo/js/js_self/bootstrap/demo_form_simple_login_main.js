...
$(function(){
    ...
    $("#jsppage").load(basePath+"/views/demo/jsp/bootstrap/demo_form_simple_login.jsp");
    $.ajax({
        url: basePath+"/views/demo/jsp/bootstrap/demo_form_simple_login.jsp",
        type: "GET",
    ...
    $.ajax({
        url: basePath+"/views/demo/css/bootstrap/demo_form_simple_login.css",
        type: "GET",
        success: function(data){
            $("#code_css").val(data);
    ...
    $.ajax({
        url: basePath+"/views/demo/js/js_self/bootstrap/demo_form_simple_login.js",
        type: "GET",
        success: function(data){
