...
<head>
	...
	<!-- 以下私有功能引用 --> 
	<script src="../../js/js_self/bootstrap/demo_form_simple_login_main.js" type="text/javascript"></script>
    <link   href="../../css/bootstrap/demo_form_simple_login_main.css" type="text/css" rel="stylesheet" media="screen">   
</head>
<body>
	<div id="jsppage"></div>
	<div id="tabs">
