...
<head>
	...
	<!-- 以下私有功能引用 --> 
	<script src="../js/js_self/demo_form_simple_picture_main.js" type="text/javascript"></script>
    <link   href="../css/demo_form_simple_picture_main.css" type="text/css" rel="stylesheet" media="screen">   
</head>
