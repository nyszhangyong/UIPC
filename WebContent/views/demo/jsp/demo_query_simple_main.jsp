...
<head>
	...
	<!-- 以下私有功能引用 --> 
	<script src="../js/js_self/demo_query_simple_main.js" type="text/javascript"></script>
    <link   href="../css/demo_query_simple_main.css" type="text/css" rel="stylesheet" media="screen">   
</head>
<body>
	<div id="jsppage"></div>
	<div id="tabs">
